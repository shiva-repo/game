...
void ARocketDodgerGameMode::BeginPlay()
{
	...
	for (TActorIterator<AActor> It(GetWorld()); It; ++It)
	{
		...
		if (ClassName.Contains(TEXT("SkyAtmosphere")) || ClassName.Contains(TEXT("ExponentialHeightFog")) || 
			ClassName.Contains(TEXT("StaticMeshActor")) || ActorName.Contains(TEXT("Floor")) || 
			ActorName.Contains(TEXT("Sky")) || ActorName.Contains(TEXT("Grid")))
		{
